...
//    println("EBIT margin is " + "%.4f".format(EBITmargin))
  ...
  @Test def testK3T5() {
    ...
    val g = 0.068
    val Div1 = 1.02
    val res2 = x.constantDividendSharePrice(Div1, r, g)
    val res3 = x.constantDividendGrowthRate(r, Div1, SP)
    println("SP is " + "%.4f".format(res2))
    println("growth rate estimate is " + "%.4f".format(res3))
  }
